...
public class BillingResult
{
	...
	public BillingResult(int response, String message)
	{
		...
		{
			mMessage = BillingResponseCodes.getResponseDesc(response);
		}
		else
		{
			mMessage = message + " (response: " + BillingResponseCodes.getResponseDesc(response) + ")";
		}
	}
	...
	{
		return mResponse == BillingResponseCodes.BILLING_RESPONSE_RESULT_OK;
	}
	...
	{
		return "Message: " + getMessage() + " " + "Response:" + getResponse();
	}
