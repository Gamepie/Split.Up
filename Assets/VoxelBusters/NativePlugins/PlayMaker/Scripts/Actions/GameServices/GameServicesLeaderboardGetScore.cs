...
namespace VoxelBusters.NativePlugins.PlayMaker
{
	...
	[Tooltip("Gets the score details from the leaderboard and stores it in variables.")]
	public class GameServicesLeaderboardGetScore : FsmStateAction 
	{
		#region Fields
		...
		[Tooltip("The index to retrieve the score from.")]
		...
		public override void OnEnter ()
		{
			...
			try
			{
				...
				Score		_score			= _leaderboard.Scores[atIndex.Value];
