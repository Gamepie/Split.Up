...
namespace VoxelBusters.NativePlugins.PlayMaker
{
	...
	[Tooltip("Sets whether web view scales webpages to fit the view and the user can change the scale.")]
	public class WebViewSetScalesPageToFit : FsmStateAction 
	{
		#region Fields
		...
		[Tooltip("If enabled, web view scales webpages to fit the view.")]
