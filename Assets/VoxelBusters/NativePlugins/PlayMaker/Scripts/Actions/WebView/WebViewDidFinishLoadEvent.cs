...
namespace VoxelBusters.NativePlugins.PlayMaker
{
	...
	[Tooltip("Registers to the event and notifies you when specified web view has finished loading.")]
	public class WebViewDidFinishLoadEvent : FsmStateAction 
	{
		#region Fields
		...
		[Tooltip("Event to send when web view has finished loading.")]
		...
		public override void OnEnter () 
		{
			...
			// Register for event
			WebView.DidFinishLoadEvent	+= OnDidFinishLoad;
#endif
		}
...
#if USES_WEBVIEW
		private void OnDidFinishLoad (WebView _webview)
		{
