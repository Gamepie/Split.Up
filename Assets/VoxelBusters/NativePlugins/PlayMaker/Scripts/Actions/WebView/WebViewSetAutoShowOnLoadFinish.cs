...
namespace VoxelBusters.NativePlugins.PlayMaker
{
	...
	[Tooltip("Sets whether web view will auto show itself on finishing load.")]
	public class WebViewSetAutoShowOnLoadFinish : FsmStateAction 
	{
		#region Fields
		...
		[Tooltip("If enabled, web view will auto show itself on finishing load.")]
		...
		private void DoAction ()
		{
			...
			_webView.AutoShowOnLoadFinish	= autoShowOnLoadFinish;
#endif
		}
