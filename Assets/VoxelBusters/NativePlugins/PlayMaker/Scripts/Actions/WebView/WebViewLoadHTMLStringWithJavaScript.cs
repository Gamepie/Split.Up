...
namespace VoxelBusters.NativePlugins.PlayMaker
{
	...
	[Tooltip("Loads the webpage contents and runs JavaScript string.")]
	public class WebViewLoadHTMLStringWithJavaScript : FsmStateAction 
	{
		#region Fields
		...
		private void DoAction ()
		{
			...
			_webView.LoadHTMLStringWithJavaScript(htmlString.Value, javaScript.Value, baseURL.Value);
#endif
		}
