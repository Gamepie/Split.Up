...
namespace VoxelBusters.NativePlugins.PlayMaker
{
	...
	[Tooltip("Sets the web view frame to full screen size.")]
	public class WebViewSetFullScreenFrame : FsmStateAction 
	{
		#region Fields
		...
		private void DoAction ()
		{
			...
			// Set webview frame to full screen mode
			_webView.SetFullScreenFrame();
#endif
		}
