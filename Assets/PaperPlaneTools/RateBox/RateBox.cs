...
namespace PaperPlaneTools
{
	...
	public class RateBox 
	{
		...
		/// </param>
		public void Init(string rateUrl, RateBoxConditions conditions = null, RateBoxTextSettings textSettings = null) 
		{
			int time = Time ();
		...
		public bool CheckConditionsAreMet()
		{
			...
			if(Conditions.RequireInternetConnection && Network.player.ipAddress == "0.0.0.0"){ 
				DebugLog(String.Format(
